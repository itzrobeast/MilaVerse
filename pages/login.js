...
export default function Login() {
  ...
  const handleLogin = () => {
    ...
    FB.login(
      ...
      {
        scope: 'public_profile,email,pages_show_list,pages_messaging,business_management,pages_read_engagement,ads_management,pages_manage_metadata,pages_manage_ads,pages_messaging,instagram_manage_messages,leads_retrieval,instagram_basic',
        return_scopes: true,
      }
    );
  };
